...
const NavBar = () => {
  ...
  return (
    <div>
      ...
      <TopNav />
      <div className='flex justify-between sm:py-4 py-0 gap-[10rem] items-start'>
        ...
        <ul className='sm:flex hidden sm:flex-row ul flex-col sm:items-center sm:justify-end items-end sm:pt-[1px] pt-[5rem] sm:pr-[auto] pr-[2rem]  sm:h-[auto] w-[80%] h-[100vh]  m-auto sm:relative fixed left-[-5rem]  sm:left-0 bg-[#04333acc]  sm:bg-transparent sm:gap-5 gap-4 font-semibold sm:text-lg  text-[2rem] flex-wrap'>
